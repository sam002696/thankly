...
const HomePage = () => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="w-full h-16 bg-amber-50 relative z-20">
        <div className="absolute w-full h-8 bottom-0" style={{ ...tornEdgeBottom, backgroundColor: '#F5A623' }}></div>
      </div>

      <HowItWorksSection />

      {/* Torn edge transition: how it works → wall of thanks */}
      <div className="w-full h-12 bg-amber-50 relative z-20 -mt-6" style={tornEdgeTop}></div>

      <WallOfThanksSection />

      {/* Wave transition: wall of thanks → editor */}
      <div className="w-full relative overflow-hidden leading-none text-amber-500 bg-amber-50 z-10 -mb-1">
      ...
      <div className="w-full h-16 bg-red-500 relative z-20">
        <div className="absolute w-full h-8 bottom-0 rotate-180" style={{ ...tornEdgeBottom, backgroundColor: '#F5A623' }}></div>
      </div>
