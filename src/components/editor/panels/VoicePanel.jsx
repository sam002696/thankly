...
import { setVoiceUrl, setIsRecording, setRecordingDuration } from '../../../store/slices/editorSlice'

export default function VoicePanel() {
  const dispatch = useDispatch()
  const { voiceUrl, isRecording, recordingDuration } = useSelector(s => s.editor)
        ...
        {!voiceUrl ? (
            ...
            <div className="text-center">
              {isRecording ? (
                <>
                  ...
                  <p className="text-xs text-ink/50 mt-1">Recording... tap to stop</p>
                </>
              ) : (
                <>
                  <p className="font-semibold text-ink text-sm">Tap to record</p>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 text-sm font-semibold text-brand border-2 border-brand rounded-xl hover:bg-brand/5 transition-all"
            >
              🗑 Delete & re-record
            </button>
          </div>
